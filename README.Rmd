...
To install a stable version, you can install ShinyLink from CRAN. (Coming soon)
...
Download and install the latest version of R for your Mac From CRAN: https://cran.r-project.org/bin/macosx/
